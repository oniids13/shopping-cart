            ...
            <div className="row bg-body rounded-3 p-5">
                ...
                <div className="col-6">
                    ...
                    <div className="product-counter mt-3">
                        <button className="btn btn-sm btn-primary" onClick={handleDecrement}>-</button>
                        <input type="number" name="qty" id="qty" max={10} min={0} value={count} />
                        <button className="btn btn-sm btn-primary" onClick={handleIncrement}>+</button>
                        <button onClick={addToCart} className="btn btn-primary mx-3">
